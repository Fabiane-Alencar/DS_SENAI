...
/*
VARIÁVEL QUE RECEBE A 1 IMAGEM E FUNCIONARÁ COMO UM CONTADOR INICIANDO EM ZERO
...
function nextSlider() {
    ...
    if(currentSlide === slider.length -1) {
        currentSlide = 0 /*VOLTA PARA O 1 SLIDE SE TIVER NO ULTIMO SLIDES*/
    }else{
        currentSlide++ /*SENÃO ELE AVANÇA POARA O PRÓXIMO*/
